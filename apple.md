## Для яблодрочеров (приложение Streisand)
### Шаги настройки ВПН (выполняется один раз, потом просто пользуемся с кайфом):

1) Устанавливаем приложение: [https://apps.apple.com/ru/app/streisand/id6450534064](https://apps.apple.com/ru/app/streisand/id6450534064)
