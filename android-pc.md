# Для Windows, Android, Linux
### Шаги настройки ВПН (выполняется один раз, потом просто пользуемся с кайфом):

1.  Устанавливаем приложение **Hiddify**:
    

-   Приложение для ПК необходимо выбрать по ссылке под вашу операционную систему: [https://github.com/hiddify/hiddify-next/releases](https://github.com/hiddify/hiddify-next/releases)
...
5.  Включаем режим **"VPN"**, после данного действия перезапускаем приложение:
...
6.  Если все сделали правильно, то вы увидите примерно такую картину. Нажимаем кнопку **«Нажмите для подключения»** и пользуемся:
